...
function init(settings = default_settings) {
	...
	options = {
		...
		dev: false,
		entry: {
			file: assets + '/_app/start-52a30ffe.js',
			css: [assets + '/_app/assets/start-61d1577b.css'],
			js: [assets + '/_app/start-52a30ffe.js', assets + '/_app/chunks/vendor-07977a97.js']
		},
		fetched: void 0,
		floc: false,
...
var metadata_lookup = {
	'src/routes/__layout.svelte': {
		entry: 'pages/__layout.svelte-9e044f03.js',
		css: ['assets/pages/__layout.svelte-1fda6867.css'],
		js: ['pages/__layout.svelte-9e044f03.js', 'chunks/vendor-07977a97.js'],
		styles: []
	},
	'.svelte-kit/build/components/error.svelte': {
		entry: 'error.svelte-3186ff52.js',
		css: [],
		js: ['error.svelte-3186ff52.js', 'chunks/vendor-07977a97.js'],
		styles: []
	},
	'src/routes/index.svelte': {
		entry: 'pages/index.svelte-c5b44e9d.js',
		css: ['assets/pages/index.svelte-b6f83df6.css'],
		js: ['pages/index.svelte-c5b44e9d.js', 'chunks/vendor-07977a97.js'],
		styles: []
	},
	'src/routes/about.svelte': {
		entry: 'pages/about.svelte-9cf03014.js',
		css: ['assets/pages/about.svelte-bf4528fa.css'],
		js: ['pages/about.svelte-9cf03014.js', 'chunks/vendor-07977a97.js', 'chunks/env-a13806e5.js'],
		styles: []
	},
	'src/routes/todos/index.svelte': {
		entry: 'pages/todos/index.svelte-1f775d92.js',
		css: ['assets/pages/todos/index.svelte-784042c1.css'],
		js: ['pages/todos/index.svelte-1f775d92.js', 'chunks/vendor-07977a97.js'],
		styles: []
	},
	'src/routes/vgdd.svelte': {
		entry: 'pages/vgdd.svelte-d9da7d43.js',
		css: ['assets/pages/vgdd.svelte-2179e6dc.css'],
		js: ['pages/vgdd.svelte-d9da7d43.js', 'chunks/vendor-07977a97.js', 'chunks/env-a13806e5.js'],
		styles: []
	}
};
	...
	<nav class="${'svelte-t2wq17'}"><svg viewBox="${'0 0 2 3'}" aria-hidden="${'true'}" class="${'svelte-t2wq17'}"><path d="${'M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z'}" class="${'svelte-t2wq17'}"></path></svg>
		...
		.trim()}"><a sveltekit:prefetch href="${'/'}" class="${'svelte-t2wq17'}">Home</a></li>
			...
			<li class="${['svelte-t2wq17', $page.path === '/todos' ? 'active' : '']
				.join(' ')
				.trim()}"><a sveltekit:prefetch href="${'/todos'}" class="${'svelte-t2wq17'}">Todos</a></li>
			<li class="${['svelte-t2wq17', $page.path === '/vgdd' ? 'active' : '']
				.join(' ')
				.trim()}"><a sveltekit:prefetch href="${'/vgdd'}" class="${'svelte-t2wq17'}">VGDD</a></li></ul>
...
var Counter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	<div class="${'counter-viewport svelte-139m1ow'}"><div class="${'counter-digits svelte-139m1ow'}" style="${
		'transform: translate(0, ' + escape(100 * offset) + '%)'
	}"><strong style="${'top: -100%'}" aria-hidden="${'true'}" class="${'svelte-139m1ow'}">${escape(
...
var css$1 = {
	code: '.active.svelte-ky1cu7{background:lime}',
	map: `{"version":3,"file":"index.svelte","sources":["index.svelte"],"sourcesContent":["<script lang=\\"ts\\">const numbers = [9, 8, 7, 6, 5, 4, 3, 2, 1, 'DEL', 0, 'OK'];\\nconst onClickNumber = (number) => {\\n    if (number === 'DEL') {\\n        if (isAnyActive) {\\n            items = items.filter((item) => !item.active);\\n            isAnyActive = false;\\n            return;\\n        }\\n        current = current.slice(0, -1);\\n        return;\\n    }\\n    if (number === 'OK') {\\n        if (value) {\\n            items = [\\n                ...items,\\n                {\\n                    id: current + ' - ' + value,\\n                    number: current,\\n                    label: value\\n                }\\n            ];\\n            current = '';\\n            value = '';\\n        }\\n        else {\\n            ref.focus();\\n        }\\n        return;\\n    }\\n    current += number;\\n};\\nconst onSubmit = () => onClickNumber('OK');\\nconst onClickItem = (id) => {\\n    items = items.map((item) => {\\n        if (item.id === id) {\\n            item.active = !item.active;\\n        }\\n        if (item.active) {\\n            isAnyActive = true;\\n        }\\n        return item;\\n    });\\n};\\nlet current = '';\\nlet items = [];\\nlet value = '';\\nlet ref;\\nlet isAnyActive = false;\\n$: display = current;\\n<\/script>\\n\\n<div>\\n\\t<form on:submit|preventDefault={onSubmit}>\\n\\t\\t{#each numbers as number}\\n\\t\\t\\t<button type=\\"button\\" on:click={() => onClickNumber(number)}>{number}</button>\\n\\t\\t{/each}\\n\\t\\t<input bind:value bind:this={ref} />\\n\\t</form>\\n\\n\\t{#if display}<h1>{display}</h1>{/if}\\n\\n\\t{#if items.length}\\n\\t\\t<ul>\\n\\t\\t\\t{#each items as item}\\n\\t\\t\\t\\t<li class:active={item.active} on:click={() => onClickItem(item.id)}>\\n\\t\\t\\t\\t\\t{item.number} - {item.label}\\n\\t\\t\\t\\t</li>\\n\\t\\t\\t{/each}\\n\\t\\t</ul>\\n\\t{/if}\\n</div>\\n\\n<style>\\n\\t.active {\\n\\t\\tbackground: lime;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAyEC,OAAO,cAAC,CAAC,AACR,UAAU,CAAE,IAAI,AACjB,CAAC"}`
};
var Vgdd$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	let display;
	...
	display = current;
	return `<div><form>${each(
		numbers,
		(number) => `<button type="${'button'}">${escape(number)}</button>`
	)}
		<input${add_attribute('value', value, 0)}${add_attribute('this', ref, 0)}></form>

	${display ? `<h1>${escape(display)}</h1>` : ``}

	${
		items.length
			? `<ul>${each(
					items,
					(item) => `<li class="${['svelte-ky1cu7', item.active ? 'active' : '']
						.join(' ')
						.trim()}">${escape(item.number)} - ${escape(item.label)}
				</li>`
			  )}</ul>`
			: ``
	}
...
var css = {
	code: '.content.svelte-cf77e8{width:100%;max-width:var(--column-width);margin:var(--column-margin-top) auto 0 auto}',
	map: `{"version":3,"file":"vgdd.svelte","sources":["vgdd.svelte"],"sourcesContent":["<script context=\\"module\\">\\n\\timport { browser, dev } from '$app/env';\\n\\n\\t// we don't need any JS on this page, though we'll load\\n\\t// it in dev so that we get hot module replacement...\\n\\texport const hydrate = dev;\\n\\n\\t// ...but if the client-side router is already loaded\\n\\t// (i.e. we came here from elsewhere in the app), use it\\n\\texport const router = browser;\\n\\n\\t// since there's no dynamic data here, we can prerender\\n\\t// it so that it gets served as a static asset in prod\\n\\texport const prerender = true;\\n<\/script>\\n\\n<script lang=\\"ts\\">import VGDD from '$lib/vgdd/index.svelte';\\n<\/script>\\n\\n<svelte:head>\\n\\t<title>VGDD</title>\\n</svelte:head>\\n\\n<div class=\\"content\\">\\n\\t<VGDD />\\n</div>\\n\\n<style>\\n\\t.content {\\n\\t\\twidth: 100%;\\n\\t\\tmax-width: var(--column-width);\\n\\t\\tmargin: var(--column-margin-top) auto 0 auto;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AA4BC,QAAQ,cAAC,CAAC,AACT,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,IAAI,cAAc,CAAC,CAC9B,MAAM,CAAE,IAAI,mBAAmB,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,IAAI,AAC7C,CAAC"}`
};
var hydrate = dev;
var router = browser;
var prerender = true;
...
<div class="${'content svelte-cf77e8'}">${validate_component(Vgdd$1, 'VGDD').$$render(
		$$result,
		{},
		{},
		{}
