...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-78cbce56.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-78cbce56.js", assets + "/_app/chunks/vendor-07977a97.js"]
    },
    fetched: void 0,
    floc: false,
...
var manifest = {
  ...
  routes: [
    ...
    },
    {
      ...
      pattern: /^\/vgdd\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/vgdd.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    }
  ]
};
...
var module_lookup = {
  ...
  "src/routes/vgdd.svelte": () => Promise.resolve().then(function() {
    return vgdd;
  })
};
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-2bafe62c.js", "css": ["assets/pages/__layout.svelte-6e152fb1.css"], "js": ["pages/__layout.svelte-2bafe62c.js", "chunks/vendor-07977a97.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-3186ff52.js", "css": [], "js": ["error.svelte-3186ff52.js", "chunks/vendor-07977a97.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-d35cf3a8.js", "css": ["assets/pages/index.svelte-b6f83df6.css"], "js": ["pages/index.svelte-d35cf3a8.js", "chunks/vendor-07977a97.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-9cf03014.js", "css": ["assets/pages/about.svelte-bf4528fa.css"], "js": ["pages/about.svelte-9cf03014.js", "chunks/vendor-07977a97.js", "chunks/env-a13806e5.js"], "styles": [] }, "src/routes/todos/index.svelte": { "entry": "pages/todos/index.svelte-1f775d92.js", "css": ["assets/pages/todos/index.svelte-784042c1.css"], "js": ["pages/todos/index.svelte-1f775d92.js", "chunks/vendor-07977a97.js"], "styles": [] }, "src/routes/vgdd.svelte": { "entry": "pages/vgdd.svelte-31271b5d.js", "css": ["assets/pages/vgdd.svelte-a3eeca04.css"], "js": ["pages/vgdd.svelte-31271b5d.js", "chunks/vendor-07977a97.js", "chunks/env-a13806e5.js"], "styles": [] } };
...
var Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<header class="${"svelte-t2wq17"}"><div class="${"corner svelte-t2wq17"}"><a href="${"https://kit.svelte.dev"}" class="${"svelte-t2wq17"}"><img${add_attribute("src", logo, 0)} alt="${"SvelteKit"}" class="${"svelte-t2wq17"}"></a></div>
	...
	<nav class="${"svelte-t2wq17"}"><svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-t2wq17"}"><path d="${"M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z"}" class="${"svelte-t2wq17"}"></path></svg>
		<ul class="${"svelte-t2wq17"}">
			<li class="${["svelte-t2wq17", $page.path === "/vgdd" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/vgdd"}" class="${"svelte-t2wq17"}">VGDD</a></li>
...
var css$1 = {
  code: ".display.svelte-6ucilg.svelte-6ucilg{text-align:center;padding:20px;background:#000;border:2px solid #ddd;border-radius:5px}.animate{transform:scale(1.1);background:orange !important}.display.svelte-6ucilg input.svelte-6ucilg{display:block;width:100%;font-size:30px;color:#fff}input.svelte-6ucilg.svelte-6ucilg{text-align:center;border:none;background:transparent;outline:none}.buttons.svelte-6ucilg.svelte-6ucilg{display:flex;flex-wrap:wrap;justify-content:space-around}.buttons.svelte-6ucilg button.svelte-6ucilg{width:33%;height:80px;font-size:30px;background:#000;color:#fff;border-radius:5px;border:1px solid #ddd}ul.svelte-6ucilg.svelte-6ucilg{list-style-type:none;padding:0}li.svelte-6ucilg.svelte-6ucilg{padding:15px 10px;border-top:1px solid #ddd;border-bottom:1px solid #ddd;margin-top:-1px;font-size:24px}.active.svelte-6ucilg.svelte-6ucilg{background:red;opacity:0.5}",
  map: `{"version":3,"file":"VGDD.svelte","sources":["VGDD.svelte"],"sourcesContent":["<script lang=\\"ts\\">import { onMount } from 'svelte';\\nconst numbers = [7, 8, 9, 4, 5, 6, 1, 2, 3, 'DEL', 0, 'OK'];\\nconst onClickNumber = (event, key) => {\\n    if (event) {\\n        animate(event.target);\\n    }\\n    if (key === 'DEL') {\\n        if (isAnyActive) {\\n            items = items.filter((item) => !item.active);\\n            isAnyActive = false;\\n            localStorage.setItem('items', JSON.stringify(items));\\n            return;\\n        }\\n        number = number.slice(0, -1);\\n        return;\\n    }\\n    if (key === 'OK') {\\n        if (label) {\\n            items = [\\n                ...items,\\n                {\\n                    id: number + ' - ' + label,\\n                    number,\\n                    label: label\\n                }\\n            ].sort((a, b) => a.label.localeCompare(b.label));\\n            number = '';\\n            label = '';\\n            refNumber.focus();\\n        }\\n        else {\\n            refLabel.focus();\\n        }\\n        localStorage.setItem('items', JSON.stringify(items));\\n        return;\\n    }\\n    number += key;\\n};\\nconst onSubmit = () => onClickNumber(null, 'OK');\\nconst onClickItem = (id) => {\\n    items = items.map((item) => {\\n        if (item.id === id) {\\n            item.active = !item.active;\\n        }\\n        if (item.active) {\\n            isAnyActive = true;\\n        }\\n        return item;\\n    });\\n};\\nconst onKeyDownButton = (event) => {\\n    event.stopPropagation();\\n    event.preventDefault();\\n    if (event.code === 'Enter') {\\n        refLabel.focus();\\n    }\\n};\\nconst onKeyDownNumber = (event) => {\\n    if (event.code === 'Enter') {\\n        onClickNumber(null, 'OK');\\n    }\\n};\\nconst onKeyDownLabel = (event) => {\\n    if (event.code === 'Enter') {\\n        onClickNumber(null, 'OK');\\n    }\\n};\\nconst animate = (el) => {\\n    el.classList.add('animate');\\n    setTimeout(() => el.classList.remove('animate'), 150);\\n};\\nlet items = [];\\nlet label = '';\\nlet number = '';\\nlet refNumber;\\nlet refLabel;\\nlet isAnyActive = false;\\nonMount(() => {\\n    const store = window.localStorage.getItem('items');\\n    if (store) {\\n        items = JSON.parse(store);\\n    }\\n    refNumber.focus();\\n});\\n<\/script>\\n\\n<div>\\n\\t<form on:submit|preventDefault={onSubmit}>\\n\\t\\t<div class=\\"display\\">\\n\\t\\t\\t<input\\n\\t\\t\\t\\tbind:value={number}\\n\\t\\t\\t\\tbind:this={refNumber}\\n\\t\\t\\t\\ton:keydown={(event) => onKeyDownNumber(event)}\\n\\t\\t\\t\\tinputmode=\\"none\\"\\n\\t\\t\\t/>\\n\\t\\t\\t<input\\n\\t\\t\\t\\tbind:value={label}\\n\\t\\t\\t\\tbind:this={refLabel}\\n\\t\\t\\t\\ton:keydown={(event) => onKeyDownLabel(event)}\\n\\t\\t\\t/>\\n\\t\\t</div>\\n\\t\\t<div class=\\"buttons\\">\\n\\t\\t\\t{#each numbers as number}\\n\\t\\t\\t\\t<button\\n\\t\\t\\t\\t\\ttype=\\"button\\"\\n\\t\\t\\t\\t\\ton:keydown={(event) => onKeyDownButton(event)}\\n\\t\\t\\t\\t\\ton:click={(event) => onClickNumber(event, number)}>{number}</button\\n\\t\\t\\t\\t>\\n\\t\\t\\t{/each}\\n\\t\\t</div>\\n\\t</form>\\n\\n\\t{#if items.length}\\n\\t\\t<ul>\\n\\t\\t\\t{#each items as item}\\n\\t\\t\\t\\t<li class:active={item.active} on:click={() => onClickItem(item.id)}>\\n\\t\\t\\t\\t\\t{item.number} - {item.label}\\n\\t\\t\\t\\t</li>\\n\\t\\t\\t{/each}\\n\\t\\t</ul>\\n\\t{/if}\\n</div>\\n\\n<style>\\n\\t.display {\\n\\t\\ttext-align: center;\\n\\t\\tpadding: 20px;\\n\\t\\tbackground: #000;\\n\\t\\tborder: 2px solid #ddd;\\n\\t\\tborder-radius: 5px;\\n\\t}\\n\\n\\t:global(.animate) {\\n\\t\\ttransform: scale(1.1);\\n\\t\\tbackground: orange !important;\\n\\t}\\n\\n\\t.display input {\\n\\t\\tdisplay: block;\\n\\t\\twidth: 100%;\\n\\t\\tfont-size: 30px;\\n\\t\\tcolor: #fff;\\n\\t}\\n\\n\\tinput {\\n\\t\\ttext-align: center;\\n\\t\\tborder: none;\\n\\t\\tbackground: transparent;\\n\\t\\toutline: none;\\n\\t}\\n\\n\\t.buttons {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-wrap: wrap;\\n\\t\\tjustify-content: space-around;\\n\\t}\\n\\n\\t.buttons button {\\n\\t\\twidth: 33%;\\n\\t\\theight: 80px;\\n\\t\\tfont-size: 30px;\\n\\t\\tbackground: #000;\\n\\t\\tcolor: #fff;\\n\\t\\tborder-radius: 5px;\\n\\t\\tborder: 1px solid #ddd;\\n\\t}\\n\\n\\tul {\\n\\t\\tlist-style-type: none;\\n\\t\\tpadding: 0;\\n\\t}\\n\\n\\tli {\\n\\t\\tpadding: 15px 10px;\\n\\t\\tborder-top: 1px solid #ddd;\\n\\t\\tborder-bottom: 1px solid #ddd;\\n\\t\\tmargin-top: -1px;\\n\\t\\tfont-size: 24px;\\n\\t}\\n\\n\\t.active {\\n\\t\\tbackground: red;\\n\\t\\topacity: 0.5;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AA4HC,QAAQ,4BAAC,CAAC,AACT,UAAU,CAAE,MAAM,CAClB,OAAO,CAAE,IAAI,CACb,UAAU,CAAE,IAAI,CAChB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,CACtB,aAAa,CAAE,GAAG,AACnB,CAAC,AAEO,QAAQ,AAAE,CAAC,AAClB,SAAS,CAAE,MAAM,GAAG,CAAC,CACrB,UAAU,CAAE,MAAM,CAAC,UAAU,AAC9B,CAAC,AAED,sBAAQ,CAAC,KAAK,cAAC,CAAC,AACf,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,IAAI,AACZ,CAAC,AAED,KAAK,4BAAC,CAAC,AACN,UAAU,CAAE,MAAM,CAClB,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,WAAW,CACvB,OAAO,CAAE,IAAI,AACd,CAAC,AAED,QAAQ,4BAAC,CAAC,AACT,OAAO,CAAE,IAAI,CACb,SAAS,CAAE,IAAI,CACf,eAAe,CAAE,YAAY,AAC9B,CAAC,AAED,sBAAQ,CAAC,MAAM,cAAC,CAAC,AAChB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,IAAI,CACZ,SAAS,CAAE,IAAI,CACf,UAAU,CAAE,IAAI,CAChB,KAAK,CAAE,IAAI,CACX,aAAa,CAAE,GAAG,CAClB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,AACvB,CAAC,AAED,EAAE,4BAAC,CAAC,AACH,eAAe,CAAE,IAAI,CACrB,OAAO,CAAE,CAAC,AACX,CAAC,AAED,EAAE,4BAAC,CAAC,AACH,OAAO,CAAE,IAAI,CAAC,IAAI,CAClB,UAAU,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,CAC1B,aAAa,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,CAC7B,UAAU,CAAE,IAAI,CAChB,SAAS,CAAE,IAAI,AAChB,CAAC,AAED,OAAO,4BAAC,CAAC,AACR,UAAU,CAAE,GAAG,CACf,OAAO,CAAE,GAAG,AACb,CAAC"}`
};
var VGDD = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const numbers = [7, 8, 9, 4, 5, 6, 1, 2, 3, "DEL", 0, "OK"];
  let items = [];
  let label = "";
  let number = "";
  ...
  return `<div><form><div class="${"display svelte-6ucilg"}"><input inputmode="${"none"}" class="${"svelte-6ucilg"}"${add_attribute("value", number, 0)}${add_attribute("this", refNumber, 0)}>
			<input class="${"svelte-6ucilg"}"${add_attribute("value", label, 0)}${add_attribute("this", refLabel, 0)}></div>
		<div class="${"buttons svelte-6ucilg"}">${each(numbers, (number2) => `<button type="${"button"}" class="${"svelte-6ucilg"}">${escape(number2)}</button>`)}</div></form>

	${items.length ? `<ul class="${"svelte-6ucilg"}">${each(items, (item) => `<li class="${["svelte-6ucilg", item.active ? "active" : ""].join(" ").trim()}">${escape(item.number)} - ${escape(item.label)}
				</li>`)}</ul>` : ``}
</div>`;
});
var css = {
  code: ".content.svelte-dyos45{width:100%;max-width:var(--column-width);margin:0 auto 0 auto}",
  map: `{"version":3,"file":"vgdd.svelte","sources":["vgdd.svelte"],"sourcesContent":["<script context=\\"module\\">\\n\\timport { browser, dev } from '$app/env';\\n\\n\\t// we don't need any JS on this page, though we'll load\\n\\t// it in dev so that we get hot module replacement...\\n\\texport const hydrate = dev;\\n\\n\\t// ...but if the client-side router is already loaded\\n\\t// (i.e. we came here from elsewhere in the app), use it\\n\\texport const router = browser;\\n\\n\\t// since there's no dynamic data here, we can prerender\\n\\t// it so that it gets served as a static asset in prod\\n\\texport const prerender = true;\\n<\/script>\\n\\n<script lang=\\"ts\\">import VGDD from '$lib/VGDD.svelte';\\n<\/script>\\n\\n<svelte:head>\\n\\t<title>VGDD</title>\\n</svelte:head>\\n\\n<div class=\\"content\\">\\n\\t<VGDD />\\n</div>\\n\\n<style>\\n\\t.content {\\n\\t\\twidth: 100%;\\n\\t\\tmax-width: var(--column-width);\\n\\t\\tmargin: 0 auto 0 auto;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AA4BC,QAAQ,cAAC,CAAC,AACT,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,IAAI,cAAc,CAAC,CAC9B,MAAM,CAAE,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,IAAI,AACtB,CAAC"}`
};
var hydrate = dev;
var router = browser;
var prerender = true;
var Vgdd = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${$$result.head += `${$$result.title = `<title>VGDD</title>`, ""}`, ""}

<div class="${"content svelte-dyos45"}">${validate_component(VGDD, "VGDD").$$render($$result, {}, {}, {})}
</div>`;
});
var vgdd = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": Vgdd,
  hydrate,
